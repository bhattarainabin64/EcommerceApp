...
class _MultiStepFormState extends State<MultiStepForm> {
  ...
  _continue() {
    if (_formKey.currentState!.validate()) {
      ...
      shippingModel!.setAllData(shipping);
  ...
  // get all cart items from cartProvide and set in shareprep
  ...
  Autogenerated auto = Autogenerated(
    ...
    shippingPrice: 20,
    itemPrice: 400,
    orderItems:     // use for loop to add getcartitems
        [
          OrderItems(
            name: "item1",
            price: 400,
  ...
  // get all shipping data from shipping model
  ...
  Widget build(BuildContext context) {
    ...
    setState(() {
      ...
      //       // use for loop to all elmet in cart
      //     }));
    });
